...
const journeyStages: JourneyStage[] = [
  ...
  },
  {
    ...
    story: "No wrestling with software. No chasing provider numbers. No building systems from scratch. We set up your practice portal, calendar, Medicare billing, and professional emailΓÇöso your first session can just be about the client in front of you.",
    details: [
  ...
  },
  {
    ...
    story: "Your mornings look different now. Check your calendar over coffee. See clients from your couch. Evenings, weekends, school hoursΓÇöyou decide.",
    details: [
  ...
  },
  {
    ...
    story: "We invest in your visibility. A professional profile, a professional photoshoot, and sophisticated marketingΓÇöall covered.",
    details: [
  ...
  },
  {
    ...
    story: "A path to being one of the highest-paid psychologists in the country. No targets. No quotas. Set your own rateΓÇö$250, $280, $310, or $340 per session. You keep 80%. That's $50ΓÇô80K more per year than most clinic roles.",
    details: [
      '80% to you, 20% covers everything',
      'Set your own session rate ($250ΓÇô$340)',
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          padding: isMobile ? '28px 12px' : '36px 48px',
      ...
      >
        {[
          { value: '$200K+', label: 'Earning potential', color: bloomColors.eucalyptusSage, icon: '≡ƒî▒' },
          { value: 'Freedom', label: 'Set your schedule', color: bloomColors.softTerracotta, icon: 'ΓÿÇ∩╕Å' },
          { value: 'Community', label: 'Built for psychologists', color: bloomColors.honeyAmber, icon: '≡ƒñ¥' },
        ].map((stat, i) => (

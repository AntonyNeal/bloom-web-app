...
function getErrorMessage(error) {
    if (error instanceof client_1.HalaxyApiError) {
 ...
 */
function extractNumericId(halaxyId) {
...
class HalaxySyncService {
     ...
     */
    async fullSync(halaxyPractitionerId, fhirPractitioner) {
        ...
        try {
            ...
            let appointments = [];
            try {
                appointments = await this.client.getAppointmentsByPractitioner(halaxyPractitionerId, startDate, endDate);
            ...
            if (isZoe) {
                try {
                    ...
                    try {
                        ...
                        slots = await this.client.findAvailableAppointments(startDate, endDate, 60, // 60 minute appointments
                    ...
                    errors.push({
                        ...
                        entityId: halaxyPractitionerId,
                        operation: 'sync',
                        message: `Could not sync slots: ${getErrorMessage(slotSyncError)}`,
                        timestamp: new Date(),
                    });
                }
            }
            else {
                console.log(`[HalaxySyncService] Skipping slot sync for employee ${halaxyPractitionerId}`);
            }
            ...
            if (syncLogId) {
                try {
                    await this.completeSyncLog(syncLogId, 'error', 0, getErrorMessage(error));
                }
                catch (logError) {
                    console.warn('[HalaxySyncService] Could not complete sync log:', logError);
                }
    ...
    async incrementalSync(event, resource) {
        ...
        try {
            ...
            if (syncLogId) {
                try {
                    await this.completeSyncLog(syncLogId, 'success', result.created + result.updated + result.deleted);
                }
                catch (logError) {
                    console.warn('[HalaxySyncService] Could not complete sync log:', logError);
                }
            ...
            if (syncLogId) {
                try {
                    await this.completeSyncLog(syncLogId, 'error', 0, error instanceof Error ? error.message : 'Unknown error');
                }
                catch (logError) {
                    console.warn('[HalaxySyncService] Could not complete sync log:', logError);
                }
     ...
     */
    async syncPractitioner(halaxyPractitionerId, fhirData) {
        var _a;
     ...
     */
    subtractAppointmentsFromSlots(slots, appointments) {
        const result = [];
     ...
     */
    async cleanupOldSlots(practitionerId) {
        const pool = await this.getPool();
        try {
     ...
     */
    async reconcilePractitionerSlots(practitionerId, slots) {
        const pool = await this.getPool();
        try {
     ...
     */
    async syncSlot(slot, practitionerId) {
        ...
        const scheduleId = ((_b = (_a = slot.schedule) === null || _a === void 0 ? void 0 : _a.reference) === null || _b === void 0 ? void 0 : _b.replace('Schedule/', '')) || null;
        // Extract service category if available
        const serviceCategory = ((_d = (_c = slot.serviceCategory) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.text) ||
            ((_h = (_g = (_f = (_e = slot.serviceCategory) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.coding) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.display) ||
            null;
     ...
     */
    extractLocationType(slot) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const serviceType = (_a = slot.serviceType) === null || _a === void 0 ? void 0 : _a[0];
        if (serviceType) {
            const code = ((_d = (_c = (_b = serviceType.coding) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.code) === null || _d === void 0 ? void 0 : _d.toLowerCase()) || '';
            const display = ((_g = (_f = (_e = serviceType.coding) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.display) === null || _g === void 0 ? void 0 : _g.toLowerCase()) || '';
            const text = ((_h = serviceType.text) === null || _h === void 0 ? void 0 : _h.toLowerCase()) || '';

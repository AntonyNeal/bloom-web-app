      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            become your full-time careerΓÇöyour choice. Work completely on your schedule.
            <br />
          ...
          >
            ...
            >
              <p style={{ marginBottom: '24px' }}>
                ...
                talented colleagues burn outΓÇönot because they stopped caring, but because the
              ...
              <p style={{ fontSize: isMobile ? '16px' : '17px' }}>
                This practice is built on respectΓÇöfor your expertise, your time, and the community's
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 409) {
          ...
          toast({
            title: "You've already applied! ≡ƒî▒",
      ...
      toast({
        ...
        description:
          "Your application didn't quite make it through. Please check your connection and try againΓÇöwe'd love to hear from you! ≡ƒî┐",
        variant: 'destructive',
        duration: Infinity,
      });
    } finally {
              ...
              >
                ...
                >
                  ...
                  <Textarea
                    ...
                    placeholder="What's your practice philosophy? Why Bloom? Bonus points for tech skills, social media savvy, or entrepreneurial spark ΓÇö but definitely not required!"
                    style={{
                      width: '100%',
                      minHeight: '200px',
                      padding: '16px',
                ...
                >
                  ...
                  >
                    Just for fun - what's your favourite flower? ≡ƒî╕ <span style={{ color: bloomStyles.colors.clayTerracotta }}>*</span>
                    <span style={{ 
                      display: 'block', 
                      fontSize: '12px', 
                      fontWeight: 400, 
                  ...
                  >
                    ...
                    <option value="Cherry Blossom">≡ƒî╕ Cherry Blossom</option>
                    <option value="Purple Rose">≡ƒî╣ Purple Rose</option>
                    <option value="Sunflower">≡ƒî╗ Sunflower</option>
                    <option value="Other">Γ£¿ Other (please specify)</option>
                  </select>

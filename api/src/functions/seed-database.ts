...
async function seedDrSarahChen(pool: sql.ConnectionPool): Promise<SeedResult> {
...
async function seedDatabaseHandler(
  req: HttpRequest,
...
export default seedDatabaseHandler;

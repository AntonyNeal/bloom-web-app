        ...
        <div className="flex-shrink-0 mb-[clamp(8px,2vh,24px)]">
          ...
          <div className="flex items-center justify-center gap-0">
            {[
              ...
              const isPast = 
                (key === 'details' && ['verify', 'datetime', 'session', 'payment', 'success'].includes(stepStr)) ||
                (key === 'datetime' && ['session', 'payment', 'success'].includes(stepStr)) ||
                (key === 'session' && ['payment', 'success'].includes(stepStr)) ||
                (key === 'payment' && stepStr === 'success');
              return (

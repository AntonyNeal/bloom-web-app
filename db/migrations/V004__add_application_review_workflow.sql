-- ═══════════════════════════════════════════════════════════════════════════════
-- Migration: V004__add_application_review_workflow.sql
...
--              decision_reason, waitlisted_at, accepted_at
--
...
PRINT 'Migration V004__add_application_review_workflow completed successfully';

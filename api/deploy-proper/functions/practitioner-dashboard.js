...
function findNextSession(sessions) {
    ...
    return ((_a = upcoming[0]) === null || _a === void 0 ? void 0 : _a.id) || null;
}
// ============================================================================
// Dashboard Handler
// ============================================================================
async function practitionerDashboardHandler(req, context) {
    var _a, _b, _c, _d, _e;
    ...
    try {
      ...
      `);
        const todaysSessions = sessionsResult.recordset.map(row => ({
            id: row.id,
      ...
      `);
        ...
        const weeklyStats = {
            weekStartDate: ((_a = weeklyRow.week_start) === null || _a === void 0 ? void 0 : _a.toISOString().split('T')[0]) || '',
            weekEndDate: ((_b = weeklyRow.week_end) === null || _b === void 0 ? void 0 : _b.toISOString().split('T')[0]) || '',
      ...
      `);
        ...
        const syncStatus = syncRow ? {
            ...
            lastSuccessfulSync: ((_c = syncRow.last_successful_sync) === null || _c === void 0 ? void 0 : _c.toISOString()) || null,
            lastSyncAttempt: ((_d = syncRow.last_sync_attempt) === null || _d === void 0 ? void 0 : _d.toISOString()) || null,
            syncErrors: syncRow.last_error_message ? [{
                    timestamp: ((_e = syncRow.updated_at) === null || _e === void 0 ? void 0 : _e.toISOString()) || new Date().toISOString(),
                    operation: 'sync',
                    entity: 'all',
...
// Register Function
// ============================================================================
functions_1.app.http('practitionerDashboard', {
    methods: ['GET', 'OPTIONS'],
...
exports.default = practitionerDashboardHandler;
//# sourceMappingURL=practitioner-dashboard.js.map
...
import { GraduationCap, AlertCircle, CheckCircle2, Sparkles } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="border-sage-200 shadow-lg bg-white">
          <CardHeader className="text-center space-y-4 pb-8">
            <div className="mx-auto w-20 h-20 bg-gradient-to-br from-sage-400 to-sage-600 rounded-full flex items-center justify-center shadow-md">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-lavender-50 border-2 border-lavender-200 rounded-xl p-6 space-y-3">
              <h3 className="font-display text-h5 text-text-primary mb-4">

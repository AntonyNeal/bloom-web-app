        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {services.map((service, index) => (
            <Link
              key={index}
              href={service.href}
              className="bg-blue-100/70 backdrop-blur-sm rounded-lg shadow-sm hover:shadow-md border border-blue-200/60 transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 p-6 block group"
            >
              {service.icon && (

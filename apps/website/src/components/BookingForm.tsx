        ...
        <div className="space-y-3 sm:space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border ${errors['firstName'] ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'}`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border ${errors['lastName'] ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'}`}
                style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.04)' }}
                placeholder="Smith"
                aria-required="true"
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border ${errors['email'] ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'}`}
              style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.04)' }}
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <select
                  ...
                  className={`w-full px-2 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border ${errors['dateOfBirth'] ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'}`}
                  style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.04)' }}
          ...
          <div>
            <label
              ...
              className="block text-xs font-bold text-slate-700 mb-1.5 uppercase tracking-wide"
            >
              Phone <span className="font-normal normal-case text-slate-400 text-xs">(optional)</span>
            </label>
            <input
              id="phone-input"
              type="tel"
              ...
              className={`w-full px-3 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border ${errors['phone'] ? 'border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100'}`}
              style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.04)' }}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2.5 text-base font-medium bg-white rounded-lg focus:outline-none transition-all border border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
              style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.04)' }}
            >
          ...
          {/* Action buttons */}
          <div className="flex flex-col sm:flex-row justify-between gap-3 pt-5 mt-2 border-t border-slate-200">
            <button
              type="button"
              onClick={onCancel}
              className="px-6 py-3 text-sm font-bold rounded-lg text-slate-600 bg-gradient-to-b from-white to-slate-100 border border-slate-300 hover:border-slate-400 hover:from-slate-50 hover:to-slate-150 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-1 transition-all active:scale-[0.98]"
            ...
            <button
              ...
              className={`px-8 py-3 text-sm font-bold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 border ${
                isDetailsStepValid()
      ...
      {step === 'payment' && (
        <div className="space-y-8">
          <div className="rounded-xl border-2 border-slate-300 bg-gradient-to-b from-slate-100 to-white p-6 sm:p-8" style={{ boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.04), 0 4px 12px rgba(0,0,0,0.08)' }}>
            <h3 className="text-xl font-extrabold text-slate-800 mb-5 uppercase tracking-wide">
              Payment Summary
            </h3>

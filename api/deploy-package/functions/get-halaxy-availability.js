 ...
 */
async function fetchHalaxyAvailability(startDate, endDate, duration, context) {
    var _a, _b;
    ...
    context.log(`Halaxy returned ${((_a = data._metadata) === null || _a === void 0 ? void 0 : _a.totalCount) || 0} days of availability`);
    // Convert Halaxy timeslots to FHIR Slot format
    const slots = [];
    if ((_b = data.data) === null || _b === void 0 ? void 0 : _b.timeslots) {
...
async function getHalaxyAvailability(req, context) {
    const corsHeaders = {
...
functions_1.app.http('getHalaxyAvailability', {
    methods: ['GET', 'OPTIONS'],
    authLevel: 'anonymous',
    route: 'halaxy/availability',
    handler: getHalaxyAvailability,
});
//# sourceMappingURL=get-halaxy-availability.js.map
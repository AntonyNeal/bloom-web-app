...
const sampleSocialPlatforms: SocialPlatform[] = [
  { name: 'Instagram', connected: true, followers: 1240, engagement: 4.2, lastPost: '3 days ago', recommended: true, icon: '📸' },
  { name: 'LinkedIn', connected: true, followers: 890, engagement: 2.8, lastPost: '1 week ago', recommended: true, icon: '💼' },
  { name: 'Facebook Page', connected: false, recommended: true, icon: '📘' },
  { name: 'TikTok', connected: false, recommended: false, icon: '🎵' },
  { name: 'YouTube', connected: false, recommended: false, icon: '▶️' },
];
  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
          {sources.map((source) => (
            ...
            >
              ...
              {source.trend === 'up' && <span style={{ color: colors.green }}>↑</span>}
              {source.trend === 'down' && <span style={{ color: colors.terracotta }}>↓</span>}
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        💡 <strong>Insight:</strong> Google Search and GP referrals drive 65% of your new clients. 
  ...
  return (
    ...
    >
              ...
              <div>
                ...
                {platform.connected ? (
                  ...
                  <div style={{ fontSize: '12px', color: platform.recommended ? colors.sage : colors.charcoalLight }}>
                    {platform.recommended ? '✨ Recommended for you' : 'Optional'}
                  </div>
                )}
              </div>
            </div>
      ...
      <div style={{
        ...
        📅 <strong>Posting Schedule:</strong> For best engagement, aim for 2-3 posts per week. 

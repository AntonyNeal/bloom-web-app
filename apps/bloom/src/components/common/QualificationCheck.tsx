...
export function QualificationCheck({ onEligible }: QualificationCheckProps) {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: bloomColors.warmCream,
      }}
    >
      ...
      <div className="mx-auto" style={{ maxWidth: '600px' }}>
        <div data-main-container="true">
          ...
          <motion.a
            ...
            whileHover={{
              x: -4,
              color: bloomColors.charcoalText,
            }}
            whileTap={{ scale: 0.98 }}
            transition={{
              duration: 0.2,
          ...
          <Card
            ...
            style={{
              ...
              borderRadius: '12px',
              borderColor: `${bloomColors.eucalyptusSage}1A`, // 10% opacity
              padding: '48px',
            }}
          >
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 8px 24px ${bloomColors.eucalyptusSage}25`,
                ...
                >
                  ...
                  >
                    <Sparkles
                      className="w-4 h-4"
                      style={{ color: bloomColors.honeyAmber }}
                    />
                  </motion.div>
                </div>
              </motion.div>
              ...
              <div style={{ marginTop: '32px' }}>
                ...
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${bloomColors.warmCream} 0%, #FFFFFF 50%, ${bloomColors.eucalyptusSage}08 100%)`,
                      border: `2px solid ${bloomColors.eucalyptusSage}25`,
                      padding: '24px',
                      boxShadow: `0 2px 12px ${bloomColors.eucalyptusSage}10`,
                    }}
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      >
                        <Sparkles
                          className="w-4 h-4"
                          style={{ color: bloomColors.eucalyptusSage, opacity: 0.9 }}
                        />
                      ...
                      <p
                        ...
                        style={{
                          fontSize: '15px',
                          lineHeight: 1.65,
                          color: bloomColors.mutedText,
                        }}
                      >
                        To apply, you must meet at least{' '}
                        <strong style={{ color: bloomColors.charcoalText }}>ONE</strong> of
                        these criteria:
                      </p>
                      <ul style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <li className="flex items-start gap-3">
                          <CheckCircle2
                            ...
                            style={{ color: bloomColors.eucalyptusSage, opacity: 0.95 }}
                          />
                          <span
                            style={{
                              fontSize: '15px',
                ...
                >
                  <motion.label
                    ...
                    whileHover={
                      !isMobile && !shouldReduceMotion
                        ? {
                            backgroundColor: `${bloomColors.eucalyptusSage}08`,
                          }
                        : {}
                    }
                    ...
                    style={{
                      ...
                      backgroundColor: isRegisteredPsychologist
                        ? `${bloomColors.eucalyptusSage}08`
                        : 'transparent',
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: '4px',
                        border: `2px solid ${isRegisteredPsychologist ? bloomColors.eucalyptusSage : `${bloomColors.eucalyptusSage}30`}`,
                        backgroundColor: isRegisteredPsychologist
                          ? `${bloomColors.eucalyptusSage}08`
                          : 'transparent',
                    ...
                    >
                      ...
                      <motion.input
                        ...
                        variants={{
                          blurred: {
                            scale: 1,
                            borderColor: `${bloomColors.eucalyptusSage}30`,
                          },
                          focused: shouldReduceMotion
                            ? {
                                scale: 1,
                                borderColor: bloomColors.eucalyptusSage,
                              }
                            : {
                            ...
                            >
                              <motion.div
                                ...
                                style={{
                                  ...
                                  borderRadius: '50%',
                                  background:
                                    'radial-gradient(circle, rgba(244, 208, 63, 0.3) 0%, transparent 70%)',
                                }}
                              />
                            </motion.div>
                          )}
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        ...
                        justifyContent: 'center',
                        borderRadius: '4px',
                        border: `2px solid ${hasPhd ? bloomColors.eucalyptusSage : `${bloomColors.eucalyptusSage}30`}`,
                        backgroundColor: hasPhd
                          ? `${bloomColors.eucalyptusSage}08`
                          : 'transparent',
                        transition: 'background-color 0.2s, border-color 0.2s',
                ...
                {isEligible === false && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        We encourage you to continue building your experience and reapply when you
                        meet one of our criteria. We're excited to potentially work with you in the
                        future!
                      </p>
                    </div>
                  </motion.div>
                  ...
                  <>
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        style={{
                          background: `
                        radial-gradient(ellipse 80% 60% at 50% 45%, ${bloomColors.honeyAmber}12 0%, transparent 60%),
                        radial-gradient(ellipse 60% 80% at 30% 60%, ${bloomColors.softFern}08 0%, transparent 70%),
                        radial-gradient(ellipse 70% 70% at 70% 40%, ${bloomColors.clayTerracotta}06 0%, transparent 65%),
                        ...
                        >
                          ...
                          >
                            {wildflowerValues.map((flower, i) => {
                              const flowerColor = ['#FFB6C1', '#DDA0DD', '#FFE4E1', '#E6E6FA'][
                                i % 4
                              ];
                              ...
                              return (
                                <motion.div
                                  ...
                                  style={{
                                    ...
                                    backgroundColor: bloomColors.eucalyptusSage,
                                    opacity: 0.5,
                                  }}
                          ...
                          >
                            ...
                            <motion.div
                              ...
                              style={{
                                ...
                                bottom: 0,
                                background: `linear-gradient(to bottom, ${bloomColors.softFern} 0%, ${bloomColors.eucalyptusSage} 100%)`,
                                borderRadius: '8px',
                                boxShadow: `
                            ...
                            {[
                              ...
                              <motion.div
                                ...
                                style={{
                                  ...
                                  background: `linear-gradient(${leaf.side === 'left' ? '135deg' : '225deg'}, ${bloomColors.softFern} 0%, ${bloomColors.eucalyptusSage} 100%)`,
                                  borderRadius:
                                    leaf.side === 'left'
                            ...
                            >
                              ...
                              >
                                ...
                                <motion.circle
                                  ...
                                  style={{
                                    filter: `drop-shadow(0 0 15px ${bloomColors.honeyAmber}60)`,
                                  }}
                                />
                                ...
                                <defs>
                                  <radialGradient id="centerGradient">
                                    ...
                                    <stop offset="100%" stopColor={bloomColors.honeyAmber} />
                                  </radialGradient>
                                </defs>
                              </motion.svg>
                                ...
                                return (
                                  <div
                                    ...
                                    style={{
                                      width: '2px',
                                      height: '50%',
                                      background: `linear-gradient(to bottom, ${bloomColors.honeyAmber}40, transparent)`,
                ...
                >
                  <Button
                    ...
                    style={{
                      ...
                      border: 'none',
                      boxShadow:
                        isButtonHovered && allQualified
                          ? `0 8px 28px ${bloomColors.eucalyptusSage}40`
                          : `0 4px 16px ${bloomColors.eucalyptusSage}25`,
                      opacity: !allQualified ? 0.7 : 0.95,
                      transition: 'all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
                      cursor: !allQualified ? 'not-allowed' : 'pointer',
                      transform:
                        isButtonHovered && allQualified ? 'translateY(-2px)' : 'translateY(0)',
                    }}
                  >
                    ...
                    {!isMobile && showInkSpread && (
                      <motion.div
                        ...
                        style={{
                          ...
                          width: '300%',
                          height: '300%',
                          background: `radial-gradient(circle at center, ${bloomColors.softFern}30 0%, transparent 70%)`,
